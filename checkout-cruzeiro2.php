...
<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="loja.php">Produtos Cruzeiro</a>
			</div>
			<div class="collapse navbar-collapse" id="navbar-collapse-id">
				<ul class="nav navbar-nav">
					<li class="active"><a href="cruzeiro teste.php">Sobre</a></li>
...
<div	class="container">
					...
					<h1>Boa escolha!</h1>
					<p>Obrigado	por	comprar	na loja do maior de minas!
...
<div	class="panel panel-success">
					...
					<img	src="img/produtos/novidade2.png" class="img-thumbnail	img-responsive">
                 <dl>
					<dt>Cor</dt>
					<dd>Marinho</dd>
					<dt>Tamanho</dt>
...
<form	class="col-sm-8">
					...
					<div	class="checkbox">
									<label>
													...
													Quero receber spam do Cruzeiro
									</label>
					</div>
					</fieldset>
						<fieldset	class="col-md-6">
...
<script	src="js/total-cruzeiro.js"></script>
